...
const update = (state, msg) => {
  ...
  switch (msg.type) {
    case "CLAIM_ALL_SHARES": return { ...state, shareClaims: "loading" }
    case "CLAIMED_SHARES": return { ...state, shareClaims: msg.delegations }

    case "CONNECT": return { ...state, databaseContents: "loading", shareStatus: undefined }
